...
root = tk.Tk()
canvas = tk.Canvas(root, width=400, height=200, borderwidth=0, highlightthickness=0, bg="black")
canvas.grid()
...
def _create_spaceship(self, x, y, dir, **kwargs):
    if "start" in kwargs and "end" in kwargs:
        kwargs["extent"] = kwargs["end"] - kwargs["start"]
        del kwargs["end"]
    return self.create_arc(x-r, y-r, x+r, y+r, **kwargs)
tk.Canvas.create_spaceship = _create_spaceship
